...
Putting these all together in a command:
    ...
    ./build.sh -a amd64 -k /home/alex/key.rsa -i /home/alex/smbclient/ -o /home/alex/ -t
...
| linux/arm/v6   | 3.13           | \`arm/v6\`   | \`armhf\`           |
| linux/arm/v7   | 3.13           | \`arm/v7\`   | \`armv7\`           |
| linux/arm64/v8 | 3.13           | \`arm64\`    | \`aarch64\`         |
| linux/386      | 3.13           | \`386\`      | \`x86\`             |
| linux/ppc64le  | 3.13           | \`ppc64le\`  | \`ppc64le\`         |
| linux/s390x    | 3.13           | \`s390x\`    | \`s390x\`           |" >README.md
